<div class="main-header bg-header wow fadeInDown">
    <div class="container">
        <a href="index.html" class="header-logo" title="Delight - Create perfect presentation websites"></a><!-- .header-logo -->
        <div class="right-header-btn">
            <div id="mobile-navigation">
                <button id="nav-toggle" class="collapsed" data-toggle="collapse" data-target=".header-nav" aria-expanded="false" aria-controls="navbar"><span></span></button>
            </div>
            ...
            <li class="sf-mega">
                ...
                <ul class="sf-mega-menu clearfix">
                    ...
                    <li class="col-lg-6 col-xs-12 col-sm-4 col-md-6">
                        ...
                        <div class="clearfix">
                            <div class="owl-slider-5 slider-wrapper owl-carousel owl-theme" style="opacity: 0; display: block;">
                                <div class="owl-wrapper-outer" style="height: 0px;"><div class="owl-wrapper" style="width: 0px; left: 0px; display: block;"><div class="owl-item" style="width: 0px;"><div>
                                            ...
                                            </div></div><div class="owl-item" style="width: 0px;"><div>
                                                <a href="blog-single.html" title="">
