<div class="top-bar bg-topbar">
    <div class="container">
        <div class="float-left">
            <a href="#" class="btn btn-sm bg-facebook tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Facebook">
                <i class="glyph-icon icon-facebook"></i>
            </a>
            <a href="#" class="btn btn-sm bg-google tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Google+">
                <i class="glyph-icon icon-google-plus"></i>
            </a>
            <a href="#" class="btn btn-sm bg-twitter tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Twitter">
        ...
        <div class="float-right user-account-btn dropdown">
            <a href="../admin-template/index.html" title="DelightUI Admin Template" class="btn btn-sm float-left btn-alt btn-hover mrg10R btn-default">
