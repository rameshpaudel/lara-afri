...
class WatchtowerSeeder extends Seeder
{
     /**
    ...
    public function run()
    {
        ...
        $roles = [
            [ 
                'name'          => 'Administrators',
                'slug'          => 'admin',
                'description'   => 'Superadmin of the site. Have all access to all areas',
                'special'       => 'all-access',
            ],
            ...
            [
                'name'          => 'Personal Users',
                'slug'          => 'personal-user',
                'description'   => 'Normal Users with basic permission',
                'special'       => null,
            ],
            [
                'name'          => 'Business Users',
                'slug'          => 'business-user',
                'description'   => 'Business Users with advanced permissions',
                'special'       => null,
            ],
        ];
        ...
        $permissions = [
            [ 
                ...
                'description'   => 'View the dashboard shortcuts page'
            ],
